...
public class WelcomeScreens {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("appActivity", "com.pinbonus.ActivityWelcomeScreens");
...
//        WebElement cards_block = driver.findElement(By.id("asslvRecords"));
//        assertNotNull(cards_block);
    }
